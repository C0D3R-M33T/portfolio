...
const Home = () => (
  <Layout>
    <Container>
      ...
      >
        Hello, I&apos;m what you want to say about yourself!
      </Box>
      ...
      <Box display={{ md: 'flex' }}>
        <Box flexGrow={1}>
          ...
          <p>Hello! Lorem Ipsum. Some tag line about yourself</p>
        </Box>
        <Box
          flexShrink={0}
          mt={{ base: 4, md: 0 }}
      ...
      <Section delay={0.3}>
        ...
        <li><section>Lorem ipsum dolor sit amet, consectetur adipiscing elit</section></li>
        <li><section>Lorem ipsum dolor sit amet, consectetur adipiscing elit</section></li>
        <li><section>Lorem ipsum dolor sit amet, consectetur adipiscing elit</section></li>
        <li><section>Lorem ipsum dolor sit amet, consectetur adipiscing elit</section></li>
      </Section>
